...
const PaginationContainer = () => {
	const { response } = useLoaderData() as  NewsResponseWithParams | BlogsResponseWithParams;
	...
	if ("total_count" in response) {
		objectsInTotal = Number(response.total_count);
	} else {
		objectsInTotal = Number(response.count);
	}
